...
"""
    ...
    async def save_callback(self, interaction: discord.Interaction):
        ...
        # Сохраняем в БД
        try:
            self.bot.db.update_guild_settings(self.draft.guild_id, self.draft.get_draft())
    ...
    async def reset_callback(self, interaction: discord.Interaction):
        ...
        try:
            ...
            self.bot.db.delete_guild_settings(self.draft.guild_id)
            
            # Создаём настройки по умолчанию
            default_settings = self.bot.db.create_default_guild_settings(self.draft.guild_id)
